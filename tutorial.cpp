...
void Tutorial::trace( const RayGenCameraData& camera_data )
{
  ...
  //m_box["boxvelocity"]->setFloat(velocity);
...
void Tutorial::createGeometry()
{
  ...
  // Create box
  Geometry box0 = m_context->createGeometry();
  box0->setPrimitiveCount( 1u );
  box0->setBoundingBoxProgram( box_bounds );
  ...
  // Create box
  m_box = m_context->createGeometry();
  m_box->setPrimitiveCount( 1u );
  m_box->setBoundingBoxProgram( box_bounds );
  ...
  box2["boxvelocity"]->setFloat( 0.3f, 0.0f, 0.0f);
    ...
    // Create box
  Geometry box3 = m_context->createGeometry();
  ...
  if(m_tutnum >= 3) {
    Program box_ah = m_context->createProgramFromPTXFile( m_ptx_path, "any_hit_shadow_rel" );
  ...
  Program box_ch1 = m_context->createProgramFromPTXFile( m_ptx_path, box_chname );
  box_matl1->setClosestHitProgram( 0, box_ch1 );
  if(m_tutnum >= 3) {
    Program box_ah = m_context->createProgramFromPTXFile( m_ptx_path, "any_hit_shadow_rel" );
    box_matl1->setAnyHitProgram( 1, box_ah );
  }
  box_matl1["Ka"]->setFloat( 0.0f, 0.0f, 0.0f );
  box_matl1["Kd"]->setFloat( 0.6f, 0.7f, 0.8f );
  ...
  Program box_ch2 = m_context->createProgramFromPTXFile( m_ptx_path, box_chname );
  box_matl2->setClosestHitProgram( 0, box_ch2 );
  if(m_tutnum >= 3) {
    Program box_ah = m_context->createProgramFromPTXFile( m_ptx_path, "any_hit_shadow_rel" );
    box_matl2->setAnyHitProgram( 1, box_ah );
  }
  box_matl2["Ka"]->setFloat( 0.0f, 0.0f, 0.0f );
  box_matl2["Kd"]->setFloat( 0.6f, 0.7f, 0.8f );
  ...
  Program box_ch3 = m_context->createProgramFromPTXFile( m_ptx_path, box_chname );
  box_matl3->setClosestHitProgram( 0, box_ch3 );
  if(m_tutnum >= 3) {
    Program box_ah = m_context->createProgramFromPTXFile( m_ptx_path, "any_hit_shadow_rel" );
    box_matl3->setAnyHitProgram( 1, box_ah );
  }
  box_matl3["Ka"]->setFloat( 0.0f, 0.0f, 0.0f );
  box_matl3["Kd"]->setFloat( 0.6f, 0.7f, 0.8f );
  ...
  gis.push_back( m_context->createGeometryInstance( box0, &box_matl, &box_matl+1 ) );
  gis.push_back( m_context->createGeometryInstance( m_box, &box_matl1, &box_matl1+1 ) );
  gis.push_back( m_context->createGeometryInstance( box2, &box_matl2, &box_matl2+1 ) );
  gis.push_back( m_context->createGeometryInstance( box3, &box_matl3, &box_matl3+1 ) );
